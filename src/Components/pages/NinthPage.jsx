...
import backgroundImage from '../../assets/captivated.png'; // Adjust the path to your image

const NinthPage = () => {
    return (
        <div className="page-shadow flex items-center h-full justify-center bg-gray-900">
            <p
                className="text-xs leading-none text-transparent"
                style={{
                    fontSize: '12px',
                    lineHeight: '9px',
